...
import { StyleSheet, Text, View, Image, TouchableOpacity, Button, Modal,Alert } from 'react-native';
                    ...
                    return (
                        <View>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', borderBottomColor: '#AAAAAA', borderBottomWidth: 4.5, height: 60 }}>
                                ...
                                />
                                <Text style={{ fontSize: 16, marginLeft: -15 }}>Số dư hoa hồng hiện tại <Text style={{ color: '#FF5C03', fontSize: 20, fontWeight: 'bold' }}>
                                    350.000</Text></Text>
                                <Image
