            ...
            <View >
                <View>
                    <View style={{flexDirection:'row',justifyContent:'space-around'}}>
                        <View >
                            <Text style={{fontWeight:'bold'}}>Chọn năm</Text>
                        ...
                        <View>
                            <Text style={{fontWeight:'bold'}}>Chọn tháng</Text>
                            <View style={{borderColor: '#E1AC06', borderWidth: 2,borderRadius:10}}>
                                <Picker
                    ...
                    <View style={{justifyContent:'center',flexDirection:'column',alignItems:'center',margin:15}}>
